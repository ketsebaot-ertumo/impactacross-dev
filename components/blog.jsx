...
import rehypeRaw from "rehype-raw"; // enables rendering HTML like <iframe>
        ...
        <div>
          <section className="relative h-[40vh] lg:h-[60vh] w-full flex items-center justify-center bg-green-950 overflow-hidden">
            ...
            <div className="z-10 text-center px-6">
              <h1 className="text-4xl md:text-5xl font-semibold text-white drop-shadow-lg max-w-4xl mx-auto">
                {blog.title}
              </h1>
            </div>
          </section>
